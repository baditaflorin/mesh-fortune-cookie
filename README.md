...
**Live → https://baditaflorin.github.io/mesh-fortune-cookie/**

**Source → https://github.com/baditaflorin/mesh-fortune-cookie**
...
git clone https://github.com/baditaflorin/mesh-fortune-cookie
cd mesh-fortune-cookie
npm install
npm run dev
```
...
- `mesh-fortune-cookie:signalingUrl`
- `mesh-fortune-cookie:turnTokenUrl`
- `mesh-fortune-cookie:iceServers`
- `mesh-fortune-cookie:room`
